...
# Inactivar atributos
  def inactivar_atributo
    ...
    respond_to do |format|
      if @atributo.save
        format.html { redirect_to atributos_path, notice: "Atributo Inactivado" }
        format.json { render :show, status: :created, location: @atributo }
      else
        format.html { redirect_to atributos_path, alert: "Ocurrio un error al inactivar Atributo, Verifique!!..." }
        format.json { render json: @atributo.errors, status: :unprocessable_entity }
      end
    end
  end
  ...
  def activar_atributo
    ...
    respond_to do |format|
      if @atributo.save
        format.html { redirect_to atributos_path, notice: "Atributo Activado" }
        format.json { render :show, status: :created, location: @atributo }
      else
        format.html { redirect_to atributos_path, alert: "Ocurrio un error al activar Atributo, Verifique!!..." }
        format.json { render json: @atributo.errors, status: :unprocessable_entity }
      end
    end
  end
