document.addEventListener("turbolinks:load", () => {
  ...
  var var_dom_col = 
    "<'row'<'col-12 col-lg-4 custom-center'l><'col-12 col-lg-4 d-flex justify-content-center'B><'col-12 col-lg-4 custom-center'f>>" +
    "<'row'<'col-12'tr>>" +
    ...
    $(var_dom).DataTable({
      ...
      rowGroup: {
        ...
        startRender: function (rows, group, level) {
          ...
          return $('<tr/>')
            .append(`<td colspan="20" style='background-color: transparent;'> ${cellContent} </td>`)
            .addClass(className);
        },
