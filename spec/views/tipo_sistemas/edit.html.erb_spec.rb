...
RSpec.describe "tipo_sistemas/edit", type: :view do
  before(:each) do
    @tipo_sistema = assign(:tipo_sistema, TipoSistema.create!(
      nombre: "MyString",
  ...
  it "renders the edit tipo_sistema form" do
    render

    assert_select "form[action=?][method=?]", tipo_sistema_path(@tipo_sistema), "post" do
